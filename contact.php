...
<html lang="en">
  <head>
    ...
    <title>Contact - The Humanists- NGO</title>
  ...
  <body>
      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
            <span class="sr-only">The Humanists</span>
            <span class="icon-bar"></span>
            <span class="icon-bar"></span>
            <span class="icon-bar"></span>
          </button>
          <!-- You'll want to use a responsive image option so this logo looks good on devices - I recommend using something like retina.js (do a quick Google search for it and you'll find it) -->
          <a class="navbar-brand" href="index.html"><img src="images/Logo.png" style="width:10%;" /></a>
        </div>
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav navbar-right">
			...
			<li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Intiatives<b class="caret"></b></a>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-8">
          ...
          <p>Please write to us if you have any queries or suggestions</p>
        ...
        <div class="col-sm-4">
          <h3>The Humanists</h3>
          <h4>Non Profitable Organisation</h4>
          <p>
            I Main, Byrasandra<br>
            Jayanagar, Bangalore - 560011<br>
          </p>
          <p><i class="fa fa-phone"></i> <abbr title="Phone">P</abbr>: (555) 984-3600</p>
          <p><i class="fa fa-envelope-o"></i> <abbr title="Email">E</abbr>: <a href="mailto:mohdzubair6@gmail.com">info@thehumanists.com</a></p>
    ...
    <div class="container">
      ...
      <footer>
        <div class="row">
          <div class="col-lg-12">
            <p>Copyright &copy; The Humanists 2014 | Powered By: <strong>CDesigns</strong></p>
          </div>
        </div>
      </footer>
